    ...
    <div>
        ...
        <div className='row g-4 mb-4'>
          ...
          <div className='col-12 col-sm-6 col-xl-3'>
            <div className='card border-start border-4 border-primary shadow-sm h-100'>
              <div className='card-body d-flex align-items-center'>
                <div className='me-3 fs-1 text-primary'><i className='bi bi-bar-chart' /></div>
                <div>
          ...
          <div className='col-12 col-sm-6 col-xl-3'>
            <div className='card border-start border-4 border-warning shadow-sm h-100'>
              <div className='card-body d-flex align-items-center'>
                <div className='me-3 fs-1 text-warning'><i className='bi bi-currency-dollar' /></div>
                <div>
      ...
      <FormCard title='Acceso Rapido' className=''>
        <div className='row g-2'>
          {tipo === 'admin' && (
            <>
              <Link to='/postulantes' className='btn btn-outline-primary col-auto'><i className='bi bi-people me-1' />Postulantes</Link>
              <Link to='/docentes' className='btn btn-outline-primary col-auto'><i className='bi bi-mortarboard me-1' />Docentes</Link>
              <Link to='/admisiones' className='btn btn-outline-success col-auto'><i className='bi bi-check2-circle me-1' />Admision</Link>
              <Link to='/notas' className='btn btn-outline-info col-auto'><i className='bi bi-clipboard-data me-1' />Notas</Link>
              <Link to='/reportes' className='btn btn-outline-secondary col-auto'><i className='bi bi-bar-chart me-1' />Reportes</Link>
            </>
          )}
          {tipo === 'docente' && (
            <>
              <Link to='/notas' className='btn btn-outline-primary col-auto'><i className='bi bi-clipboard-data me-1' />Registrar Notas</Link>
              <Link to='/grupos' className='btn btn-outline-success col-auto'><i className='bi bi-layers me-1' />Mis Grupos</Link>
              <Link to='/reportes' className='btn btn-outline-info col-auto'><i className='bi bi-bar-chart me-1' />Reportes</Link>
            </>
          )}
          {tipo === 'postulante' && (
            <>
              <Link to='/notas' className='btn btn-outline-primary col-auto'><i className='bi bi-clipboard-data me-1' />Mis Notas</Link>
              <Link to='/postulaciones/nueva' className='btn btn-outline-info col-auto'><i className='bi bi-file-earmark-plus me-1' />Postular</Link>
              <Link to='/reportes' className='btn btn-outline-secondary col-auto'><i className='bi bi-bar-chart me-1' />Reportes</Link>
            </>
          )}
        </div>
